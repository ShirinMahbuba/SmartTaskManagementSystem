...
namespace AppSTMS.Controllers
{
    public class TeamMembersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AppUserId,Name,Designation,Email,Mobile,IsActive")] TeamMember teamMember)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AppUserId,Name,Designation,Email,Mobile,IsActive")] TeamMember teamMember)
        {
            if (id != teamMember.Id)
            {
                return NotFound();
