...
namespace AppSTMS.Controllers
{
    public class AppUsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,IsActive,CreatedOn")] AppUser appUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,IsActive,CreatedOn")] AppUser appUser)
        {
            if (id != appUser.Id)
            {
                return NotFound();
