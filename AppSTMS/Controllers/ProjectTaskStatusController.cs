...
namespace AppSTMS.Controllers
{
    public class ProjectTaskStatusController : Controller
    {
        ...
        // GET: ProjectTaskStatus/Details/5
        ...
        // GET: ProjectTaskStatus/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ProjectTaskStatus/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,StatusName,IsActive")] ProjectTaskStatus projectTaskStatus)
        {
        ...
        // POST: ProjectTaskStatus/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StatusName,IsActive")] ProjectTaskStatus projectTaskStatus)
        {
        ...
        // GET: ProjectTaskStatus/Delete/5
        ...
        // POST: ProjectTaskStatus/Delete/5
        ...
        private bool ProjectTaskStatusExists(int id)
        {
